...
// // Test that notifyYourTurn correctly returns the default position for a
// Human Player
// @Test
...
// // Test that notifyYourTurn correctly returns the appropriate position for a
// Computer Player
// @Test
...
// // Test that requestMove correctly returns the appropriate position for a
// Human Player
// @Test
...
// Assert.assertEquals(gamePlayerBlack.requestMove(model, new PositionAxial(0,
// 0, 0)).getQ(), 0);
// Assert.assertEquals(gamePlayerBlack.requestMove(model, new PositionAxial(0,
// 0, 0)).getR(), 0);
// Assert.assertEquals(gamePlayerBlack.requestMove(model, new PositionAxial(0,
...
// Assert.assertEquals(controller.getLog(), "Requested move to coordinate: Q: 0,
// R: 0, S: 0\n");
// }
