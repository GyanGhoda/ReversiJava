...
public class TestStrategies {
        ...
        public void testCaptureMostStrategyNoMoveStartGame() {
                ...
                BasicReversiModelMockTranscript model = new BasicReversiModelMockTranscript(5, boardToAdd,
                                new ComputerPlayer(PlayerType.WHITE));
        ...
        // to capture the most pieces and the second strategy is to capture cells in the
        // corner
        @Test
        ...
        // Test that tryTwoStrategies works as intended when the first strategy is
        // to capture cells in the corner and the second strategy is to capture the most
        // pieces
        @Test
        ...
        // Test that minimizeNextOpponentMove works as intended when there is one move
        ...
        // Tests that minimizeNextOpponentMove works as intended when there are multiple
        // moves
