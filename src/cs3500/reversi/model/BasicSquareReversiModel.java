...
// /**
// * Represents the model of a Reversi game. Manages the game board, players,
// and
// * game logic. In our game, the grid is made up of hexagons. The game is
// played
...
// // INVARIENT: Width must be odd and at least three. Enforced by constructor
// at
// // construction of BasicSquareReversiModel.
// private final int width;
// // the turn of the current player
// // INVARIENT: currentPlayer must be either playerBlack or playerWhite.
// Enforced
// // by changeTurns(),
...
// // INVARIENT: consectivePassedTurns must be a non-negative integer. Enforced
// by
...
// * or is less than three.
// */
// public BasicSquareReversiModel(int width, Player playerBlack, Player
// playerWhite) {
// // Enforced invarient by checking if width is odd and at least three.
...
// * or is less than three.
// */
// public BasicSquareReversiModel(int width, HashMap<Position2D, Cell> board,
...
// this.initializeCell(this.width / 2 - 1, this.width / 2 - 1,
// PlayerType.BLACK);
...
// /**
// * Adds a player's piece to the specified position on the board and updates
// the
// * game state.
// *
...
// * a move.
// * @throws IllegalArgumentException if the position does not exist in this
// game.
// */
// @Override
...
// List<Position2D> validTiles = this.isValidMoveForPlayer((Position2D) posn,
// player);
...
// // reset consectivePassedTurns counter. Enforced invarient by being
// non-negative
// // integer.
// this.consectivePassedTurns = 0;
...
// * the move is invalid.
// */
// private List<Position2D> isValidMoveForPlayer(Position2D givenPosn, Player
// playerTurn) {
...
// * @param playerTurn The player whose turn it currently is.
// * @return A list of positions forming a valid line between the given
// positions,
// * or an empty list if no valid line exists.
// */
// private List<Position2D> checkValidLineMade(Position2D givenPosn, Position2D
// posn,
// Player playerTurn) {
...
// // a proper move
// private void goDownLine(int incrementStartingPostion, int
...
// // check if the position exists on the board and is owned by the other
// player.
...
// // return the starting position for the line being made, depending on
// direction
// // given
...
// * current player.
// *
// * @param posnBetween A list of positions between which cell ownership should
// be
// * changed.
// */
...
// *
// * @throws IllegalStateException if the game has not started or if it is not
// the
// * player's turn.
// */
// @Override
...
// */
// @Override
// public boolean doesCurrentPlayerHaveValidMovesPosn(GamePosition posn, Player
// playerTurn) {
// if (this.getCellAt(posn).sameCellType(CellType.Empty)) {
...
// /**
// * Gets the current score of the given PlayerType of this Reversi game. Score
// is
...
// // returns the current winning player, white player if tied because black
// goes
// // first
// if (this.getCurrentScore(PlayerType.BLACK) >
// this.getCurrentScore(PlayerType.WHITE)) {
// return this.playerBlack.toString();
// } else if (this.getCurrentScore(PlayerType.BLACK) ==
// this.getCurrentScore(PlayerType.WHITE)) {
// return "Tie";
// } else {
